...
int main()
{
    ...
    printf("Here you can easily compute your monthly budget, total costs, leftover funds, and many other things here.\nSo let's start\n");
    fprintf(fptr, "Here you can easily compute your monthly budget, total costs, leftover funds, and many other things here.\nSo let's start\n");
    fprintf(fexpenses, "Here you can easily compute your monthly budget, total costs, leftover funds, and many other things here.\nSo let's start\n");
    fprintf(fnew, "Here you can easily compute your monthly budget, total costs, leftover funds, and many other things here.\nSo let's start\n");
    // input for income
...
//input in second file
    ...
    {
        printf("Your Remaing Money :0\nYou are behind of Rs.%.2f from your Income\n", rest * -1);
        fprintf(fnew, "Your Remaing Money :0\nYou are behind of Rs.%.2f from your Income\n", rest * -1);
